classdef DubinsCar2Dy < DynSys
  ...
  methods
    function obj = DubinsCar2Dy(x, wRange, speed, dRange, dims)
      % obj = DubinsCar2Dy(x, wMax, speed, dMax, dims)
      %     Dubins Car class
      %
      % Dynamics:
      %    \dot{x}_1 = v * sin(x_3) + d2
      %    \dot{x}_2 = u
      %         u \in [-wMax, wMax]
      %         d \in [-dMax, dMax]
      %
